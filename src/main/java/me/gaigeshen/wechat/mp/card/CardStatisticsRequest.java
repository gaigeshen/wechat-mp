...
public class CardStatisticsRequest implements Request<CardStatisticsResponse> {
  ...
  private CardStatisticsRequest(String beginDate, String endDate, int condSource) {
   ...
   * @return 统计卡券数据请求
   */
  public static CardStatisticsRequest create(boolean byApiCreated, LocalDate beginDate, LocalDate endDate) {
    return new CardStatisticsRequest(
